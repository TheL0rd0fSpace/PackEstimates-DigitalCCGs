...
print("You got the entire set, opening {} packs! At a rate of {}/pack, this would've cost you ${}! Thanks for playing!".format(str(opened_packs),str(cost_per_pack),str(opened_packs * cost_per_pack)))
